...
public abstract class PointOfInterestStorageMixin extends SectionStorage<PoiSection>
     ...
     */
    @Overwrite
    public Optional<BlockPos> getPosition(Predicate<Holder<PoiType>> typePredicate, Predicate<BlockPos> posPredicate,
     ...
     */
    @Overwrite
    public Optional<BlockPos> getNearestPosition(Predicate<Holder<PoiType>> predicate, BlockPos pos, int radius,
                                                 PoiManager.Occupancy status) {
